...
public class CommentRecyclerAdapter extends RecyclerView.Adapter<CommentRecyclerAdapter.ItemViewHolder> {
    ...
    private ReadFragment parentFragment;

    private DataComment currentData;

    CommentRecyclerAdapter(ReadFragment fragment){
                ...
                public void onClick(View v) {
                    ...
                    oDialog.setMessage("댓글을 삭제하시겠습니까?")
                            ...
                            .setNeutralButton("예", new DialogInterface.OnClickListener()
                            {
                                public void onClick(DialogInterface dialog, int which)
                                {
                                    Log.d("CommentRecyclerAdapter", "boardId = " + Integer.toString(MainActivity.boardId) + ", commentId = " + currentData.getId() + ", password = " + MainActivity.userId);
                                    AmplifyApi.CommentDelete(Integer.toString(MainActivity.boardId), currentData.getId(), MainActivity.userId);
